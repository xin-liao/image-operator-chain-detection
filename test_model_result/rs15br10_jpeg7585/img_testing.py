...
root='D:/software/caffe/examples/forensics/rs15br10_jpeg7585/'   #æ ¹ç®å½?
deploy=root + 'deploy.prototxt'    #deployæä»¶
caffe_model=root + 'Net_iter_120000.caffemodel'   #è®­ç»å¥½ç caffemodel
...
#ç»æä¿å­è·¯å¾
fresult = open('boss_rs15br10_jpeg7585_result.txt','w')
#è·åæµè¯å¾åçè·¯å¾?
firstfolder = 'F:/boss/boss_rs15br10_jpeg7585'
